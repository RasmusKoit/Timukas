...
class AboutPage extends StatelessWidget {
  ...
  final List<String> contentList = [
    ...
    '🌐 Language Insights: With SONAPI integration, you can dive deeper into the Estonian language. Get extra information and insights about the words you\'re learning.',
    ...
    '📚 Word Source: For word generation, Timukas uses the Eesti Keele Instituut word lemmad2013.txt file, a trusted resource for Estonian words.',
    'Explore the world of Estonian words with Timukas!'
  ];
